...
par.verbose_level = 1; 
par.base_path = '/home/Shared/20241001_13HB/DAY6-1006/projection_microscope/FPGA_lamin_loc1_num720_ref10_ang0-360_exp2.5s/processed/'; 
...
stack_object = permute(project_data(130:500,130:500,:),[2 1 3]);
...
%%
% very important
CoR_offset_v = 0; %rotation center - center of fov
CoR_offset_offset = 0; % depends on figure 9 find RC
...
CoR_offset_v_recon = 0; % depends on figure 9 find RC %not important?
CoR_offset = 0;
