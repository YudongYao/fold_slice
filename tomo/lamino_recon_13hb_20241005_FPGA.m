...
par.verbose_level = 1; 
par.base_path = '/home/Shared/20241001_13HB/DAY5-1005/FPGA_lamin_d48mm_loc1_num720_ref10_ang0-360/processed/'; 

filename = 'img_processed.hdf5';%dark-field 
...
for jj=1:size(stack_object,3)
    stack_object(:,:,jj) = stack_object(:,:,jj) - mean(stack_object(:,:,jj));
end
utils.verbose(-1,'Done')
...
%%
% very important
CoR_offset_v = 997-1984/2; %rotation center - center of fov
CoR_offset_offset = 971-1984/2; % depends on figure 9 find RC
...
CoR_offset_v_recon = 1028-length(reconstruct_ROI2{1})/2; % depends on figure 9 find RC %not important?
CoR_offset = 1004-length(reconstruct_ROI2{2})/2;
...
%% save tomogram
par.scans_string = 'projs1441_lanmi_angle65';
par.rec_delta_info = 'FBP_CoR_offset-19';
