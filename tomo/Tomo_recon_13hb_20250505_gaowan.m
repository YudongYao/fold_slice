...
par.verbose_level = 1; 
par.base_path = '/home/Shared/20250505_mirror/20250505/gaowan_R_tes/trans_tomo_sample2det485mm_step_720_flat20degree_exp500ms/processed/'; 
...
par.is_laminography = false;         % false -> standard tomography / limited angle tomography
                                    % true = allow some specific options for laminography reconstruction, ie circular field of view ...
% default settings for Lamni
par.lamino_angle = 90;        % laminography angle, should be 90 for common tomo
...
%%%%%%%%%% Other parameters %%%%%%%%
max_binning = 8;   % prevent binning to make smaller object than 100 pixels, reconstruction gets unstable 
min_binning = 1 ; 


%%%%%%%%%% Useful tuning parameters %%%%%%%%%%%%%%%
par.high_pass_filter = 0.001;        % remove effect of residuums/bad ptycho convergence , high value may get stack in local minima , low value increases sensitivity to residua / phase jumps 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%% Other settings %%%%%%%%%%%%%%%%%%%%%%%%%
par.showsorted = false;              % selected angular order for alignment 
