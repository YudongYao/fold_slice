...
par.verbose_level = 1; 
par.base_path = '/home/Shared/20241001_13HB/DAY6-1006/projection_microscope/crl_6k_lamin_1_loc1_num720_ref10_exp2.5s_ang0-360/processed/'; 
...
stack_object = permute(project_data(150:550,50:550,:),[2 1 3]);
...
stack_object = exp(1j*stack_object*100);
...
%%
% very important
CoR_offset_v = 226- sino_size(1)/2; %rotation center - center of fov
CoR_offset_offset = 227-sino_size(2)/2; % depends on figure 9 find RC
...
CoR_offset_v_recon =213-sino_size(1)/2; % depends on figure 9 find RC %not important?
CoR_offset = 206-sino_size(2)/2;
