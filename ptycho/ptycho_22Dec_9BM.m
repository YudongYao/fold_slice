...
caller = dbstack;
if length(caller)==1
    base_path = 'C:\Users\yudongyao\Work\Data\ptycho_9BM\ML_recon\';
    scan_string_format = 'scan%03d';
    %output_path = base_path;
    output_path = 'C:\Users\yudongyao\Work\Data\ptycho_9BM\ML_recon\ptycho_recon\';
    ...
    use_low_res_recon = false;
   	recon_dir_low_res = '\roi0_Ndp300\MLc_L1_p10_g21_Ndp64_m0.5_pc1_noModel_vp3_vi_mm\Niter100.mat';
...
% Geometry
p.   z = 2;                                             % Distance from object to detector. Always 1 for electron ptycho
...
p.   energy = 10;                                           % Energy (in keV), leave empty to use spec entry mokev
